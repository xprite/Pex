...
**            Pins                                         : 
**              SDA pin                                    : 
**                SDA pin                                  : PTE0/SPI1_PCS1/UART1_TX/SDHC0_D1/FB_AD27/I2C1_SDA/ADC1_SE4a
**                SDA pin signal                           : 
**              SCL pin                                    : 
**                SCL pin                                  : PTE1/SPI1_SOUT/UART1_RX/SDHC0_D0/FB_AD26/I2C1_SCL/ADC1_SE5a
**                SCL pin signal                           : 
...
**            SDA Hold                                     : 0.375 us
**            SCL start Hold                               : 1.917 us
**            SCL stop Hold                                : 2.042 us
...
LDD_TDeviceData* I2C2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* I2C1_F: MULT=1,ICR=0x19 */
  I2C1_F = (I2C_F_MULT(0x01) | I2C_F_ICR(0x19)); /* Set prescaler bits */
