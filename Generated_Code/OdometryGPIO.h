...
#ifndef __OdometryGPIO_H
#define __OdometryGPIO_H
...
#define OdometryGPIO_PRPH_BASE_ADDRESS  0x400FF0C0U
  
/* Device data structure pointer used when auto initialization property is enabled. This constant can be passed as a first parameter to all component's methods. */
#define OdometryGPIO_DeviceData  ((LDD_TDeviceData *)PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_OdometryGPIO_ID))

/* Methods configuration constants - generated for all enabled component's methods */
#define OdometryGPIO_Init_METHOD_ENABLED
#define OdometryGPIO_Deinit_METHOD_ENABLED
#define OdometryGPIO_SetFieldValue_METHOD_ENABLED
#define OdometryGPIO_GetFieldValue_METHOD_ENABLED
#define OdometryGPIO_ClearFieldBits_METHOD_ENABLED
#define OdometryGPIO_SetFieldBits_METHOD_ENABLED
#define OdometryGPIO_ToggleFieldBits_METHOD_ENABLED
#define OdometryGPIO_SetFieldInputDirection_METHOD_ENABLED
#define OdometryGPIO_SetFieldOutputDirection_METHOD_ENABLED
#define OdometryGPIO_ConnectPin_METHOD_ENABLED

/* Events configuration constants - generated for all enabled component's events */
#define OdometryGPIO_OnPortEvent_EVENT_ENABLED

/* Definition of bit field constants */
#define OdometryRightPin ((LDD_GPIO_TBitField)0)

/* Definition of implementation constants */
#define OdometryGPIO_ALLOCATED_PINS_MASK 0x40U /* Mask of all allocated pins from the port */
#define OdometryGPIO_MODULE_BASE_ADDRESS PTD_BASE_PTR /* Name of macro used as the base address */
#define OdometryGPIO_PORTCONTROL_BASE_ADDRESS PORTD_BASE_PTR /* Name of macro used as the base address */
#define OdometryGPIO_AVAILABLE_EVENTS_MASK LDD_GPIO_ON_PORT_EVENT /* Mask of all available events */
#define OdometryGPIO_FIELD_0_PIN_0 LDD_GPIO_PIN_6 /* Constant for the pin in the field used in the method ConnectPin */
#define OdometryGPIO_OdometryRightPin_START_BIT 6u /* Index of the starting bit of the bit field (0 represents LSB) */
#define OdometryGPIO_OdometryRightPin_MASK 0x40u /* Mask of the bits allocated by the bit field (within the port) */
...
typedef uint32_t OdometryGPIO_TPortValue;
...
typedef OdometryGPIO_TPortValue OdometryGPIO_TFieldValue;
