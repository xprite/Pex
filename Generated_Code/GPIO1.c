...
**          Port                                           : PTC
**          Port width                                     : 32 bits
**          Mask of allocated pins                         : C
**          Interrupt service/event                        : Disabled
**          Bit fields                                     : 2
**            Bit field                                    : 
**              Field name                                 : EnableRightMotor
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : PTC2/SPI0_PCS2/UART1_CTS_b/FTM0_CH1/LCD_P22/ADC0_SE4b/CMP1_IN0/TSI0_CH15
**                  Pin signal                             : 
...
**            Bit field                                    : 
**              Field name                                 : EnableLeftMotor
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : PTC3/SPI0_PCS1/UART1_RX/FTM0_CH2/LCD_P23/CMP1_IN1
**                  Pin signal                             : 
**                  Initial pin direction                  : Output
**                    Initial output state                 : 0
**                  Initial pin event                      : Disabled
...
LDD_TDeviceData* GPIO1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOC_PDOR: PDO&=~0x0C */
  GPIOC_PDOR &= (uint32_t)~(uint32_t)(GPIO_PDOR_PDO(0x0C));                                                   
  /* GPIOC_PDDR: PDD|=0x0C */
  GPIOC_PDDR |= GPIO_PDDR_PDD(0x0C);                                                   
...
void GPIO1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* PORTC_PCR2: IRQC=0 */
  PORTC_PCR2 &= (uint32_t)~(uint32_t)(PORT_PCR_IRQC(0x0F));                                                   
  /* PORTC_PCR3: IRQC=0 */
  PORTC_PCR3 &= (uint32_t)~(uint32_t)(PORT_PCR_IRQC(0x0F));                                                   
  /* GPIOC_PDDR: PDD&=~0x0C */
  GPIOC_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x0C));                                                   
...
void GPIO1_SetFieldValue(LDD_TDeviceData *DeviceDataPtr, LDD_GPIO_TBitField Field, GPIO1_TFieldValue Value)
{
  ...
  switch (Field) {                     /* no break */
    case EnableRightMotor: {           /* bit field #0 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_EnableRightMotor_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_EnableRightMotor_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_EnableRightMotor_MASK)
        )
      );
      break;
    }
    case EnableLeftMotor: {            /* bit field #1 */
      GPIO_PDD_SetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS,
        (
          GPIO_PDD_GetPortDataOutput(GPIO1_MODULE_BASE_ADDRESS)
          & ((GPIO1_TPortValue)(~((GPIO1_TPortValue)GPIO1_EnableLeftMotor_MASK)))
        )
        | (
          ((GPIO1_TPortValue)(Value << GPIO1_EnableLeftMotor_START_BIT))
          & ((GPIO1_TPortValue)GPIO1_EnableLeftMotor_MASK)
        )
      );
      break;
    }
    ...
    case EnableRightMotor: {           /* bit field #0 */
      return
        (GPIO1_TFieldValue)(
          ...
          >> GPIO1_EnableRightMotor_START_BIT
        );
    }
    case EnableLeftMotor: {            /* bit field #1 */
      return
        (GPIO1_TFieldValue)(
          ...
          >> GPIO1_EnableLeftMotor_START_BIT
        );
    }
    default:
  ...
  switch (Field) {                     /* no break */
    case EnableRightMotor: {           /* bit field #0 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_EnableRightMotor_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_EnableRightMotor_START_BIT))
      );
      break;
    }
    case EnableLeftMotor: {            /* bit field #1 */
      GPIO_PDD_ClearPortDataOutputMask(GPIO1_MODULE_BASE_ADDRESS,
        ((GPIO1_TPortValue)GPIO1_EnableLeftMotor_MASK)
        & ((GPIO1_TPortValue)(Mask << GPIO1_EnableLeftMotor_START_BIT))
      );
      break;
    }
    default:
  ...
  switch (Field) {                     /* no break */
    case EnableRightMotor: {           /* bit field #0 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_EnableRightMotor_MASK
      );
      break;
    }
    case EnableLeftMotor: {            /* bit field #1 */
      GPIO_PDD_SetPortInputDirectionMask(GPIO1_MODULE_BASE_ADDRESS,
        GPIO1_EnableLeftMotor_MASK
      );
      break;
    }
    default:
