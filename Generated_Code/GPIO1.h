...
#define EnableRightMotor ((LDD_GPIO_TBitField)0)
#define EnableLeftMotor ((LDD_GPIO_TBitField)1)

/* Definition of implementation constants */
#define GPIO1_ALLOCATED_PINS_MASK 0x0CU /* Mask of all allocated pins from the port */
...
#define GPIO1_EnableRightMotor_START_BIT 2u /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_EnableRightMotor_MASK 0x04u /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_EnableLeftMotor_START_BIT 3u /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_EnableLeftMotor_MASK 0x08u /* Mask of the bits allocated by the bit field (within the port) */
